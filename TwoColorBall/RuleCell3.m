...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
		...
		CGFloat height = [RuleCell3 heightOfCellWithWidth:width] / 2;
		...
		_winningBallView3 = [[WinningBallView alloc] initWithFrame:CGRectMake((CGFloat) (width * 0.5),
				height * 2, (CGFloat) (width * 0.5), height)];
...
- (void)setStates3:(NSArray *)states3 {
	if (states3.count == 7) {
		_winningBallView3.redBall1.state = (NSUInteger) [states3[0] integerValue];
		_winningBallView3.redBall2.state = (NSUInteger) [states3[1] integerValue];
		_winningBallView3.redBall3.state = (NSUInteger) [states3[2] integerValue];
		_winningBallView3.redBall4.state = (NSUInteger) [states3[3] integerValue];
		_winningBallView3.redBall5.state = (NSUInteger) [states3[4] integerValue];
		_winningBallView3.redBall6.state = (NSUInteger) [states3[5] integerValue];
		_winningBallView3.blueBall.state = (NSUInteger) [states3[6] integerValue];
	}
}
