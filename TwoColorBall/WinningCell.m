...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
		...
		_termLabel = [[UILabel alloc] initWithFrame:CGRectMake((CGFloat) (termWidth * 0.05),
				kDefaultSpace, (CGFloat) (termWidth * 0.4), kDefaultLabelHeight)];
		_termLabel.font = [UIFont boldSystemFontOfSize:16.0f];

		_dateLabel = [[UILabel alloc] initWithFrame:CGRectMake((CGFloat) (termWidth * 0.05 + termWidth * 0.4),
				kDefaultSpace, (CGFloat) (termWidth * 0.5), kDefaultLabelHeight)];
		_dateLabel.textAlignment = NSTextAlignmentRight;
		_dateLabel.font = [UIFont boldSystemFontOfSize:16.0f];

		CGFloat heightOfCell = [WinningBallView heightOfCellWithWidth:(CGFloat) (termWidth * 0.9)];
		_winningBallView = [[WinningBallView alloc] initWithFrame:CGRectMake((CGFloat) (termWidth * 0.05),
				kDefaultSpace * 2 + kDefaultLabelHeight, (CGFloat) (termWidth * 0.9), heightOfCell)];
