...
- (instancetype)initWithFrame:(CGRect)frame {
	if (self = [super initWithFrame:frame]) {
		...
		_ballButton.frame = CGRectMake((CGFloat) (width * 0.1), (CGFloat) (width * 0.1), (CGFloat) (width * 0.8), (CGFloat) (width * 0.8));
		_ballButton.titleLabel.font = [UIFont systemFontOfSize:(CGFloat) (12.0f * width * 0.8 / kLabelWidth)];
