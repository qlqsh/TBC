...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
	...
	UILabel *awardLevel = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 0.0f, (CGFloat) (width * 0.2), 40.0f)];
	awardLevel.text = @"奖等";
	...
	UILabel *awardMoney = [[UILabel alloc] initWithFrame:CGRectMake((CGFloat) (width * 0.2), 0.0f,
			(CGFloat) (width * 0.3), 40.0f)];
	awardMoney.text = @"奖金";
	...
	UILabel *winningConditions = [[UILabel alloc] initWithFrame:CGRectMake((CGFloat) (width * 0.5),
			0.0f, (CGFloat) (width * 0.5), 40.0f)];
